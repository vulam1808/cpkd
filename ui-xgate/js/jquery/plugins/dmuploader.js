...
(function ($) {
  ...
  DmUploader.prototype.processQueue = function () {
    ...
    var can_continue = widget.settings.onBeforeUpload.call(widget, widget.queuePos);
    ...
    $.each(widget.getExData(), function (exKey, exVal) {
  ...
  DmUploader.prototype.setExData = function (data) {
    this.settings.extraData = data;
  };
  DmUploader.prototype.getExData = function () {
    return this.settings.extraData;
  };
