 ...
 */
@Named("reportsummaryexcel")
public class ReportSummaryExcelDataService implements ReportService {
    private static final Logger logger = LoggerFactory.getLogger(ReportSummaryExcelDataService.class);
    ...
    public Object invoke(final Map<String, Object> params) throws WebOSBOException {
        try {
            ...
            List<JSONObject> obj = businessDetailBo.countTask(dateStart, dateEnd);
            logger.debug("ReportSummaryExcelDataService params: {} ", obj.size());
