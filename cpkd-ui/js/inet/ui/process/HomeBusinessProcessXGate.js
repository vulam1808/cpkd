// #PACKAGE: homebusiness-process-xgate
// #MODULE: HomeBusinessProcessXGate
$(function () {
    iNet.ns("iNet.ui", "iNet.ui.ita");
    iNet.ui.ita.HomeBusinessProcessXGate = function (config) {
        ...
        var taskView = function(){
            ...
            $.postJSON(url.load_processHomeBusiness, _param, function (result) {
                ...
                if (CommonService.isSuccess(__result)) {
                    ...
                    me.wgBtnProcess.on('changeview', function(data){
                        var __data = data || {};
                        if (!iNet.isEmpty(__data.type || "")){
                            switch (__data.type){
                                case "process":
        ...
        iNet.ui.ita.HomeBusinessProcessXGate.superclass.constructor.call(this);
    };

    iNet.extend(iNet.ui.ita.HomeBusinessProcessXGate, iNet.ui.app.widget);
