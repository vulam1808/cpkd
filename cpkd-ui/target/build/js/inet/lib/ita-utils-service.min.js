...
"disabled")},enable:function(a){a!=null&&a.removeAttr("disabled")},createSelect:function(a,b,c,g,d,f,e,i){var h=b||[],q=c||"id",r=g||1,w=iNet.isEmpty(d)?true:d,s=iNet.isEmpty(f)?false:f,x=iNet.isEmpty(e)?{}:e,y=iNet.isFunction(i)?i:"",k={};k.id=a;k.placeholder=iNet.resources.constant.placeholder||"Select value";k.allowClear=w;k.multiple=s;k.data={results:h,text:function(j){return iNet.isEmpty(j.name)?"":j.name}};k.idValue=function(j){return j[q]};k.initSelection=function(j,o){var m=q,n=j.val().split(",")||
