...
@XPortalPageRequest(uri = "cpkd/reportsummary", result = WebConstant.ACTION_XSTREAM_JSON_RESULT)
public class ReportSummaryDataService extends DataServiceMarker {
    private static final Logger logger = LoggerFactory.getLogger(
            ReportSummaryDataService.class);
    @Inject
    ...
    protected WebDataService service(final AbstractBaseAction action, final Map<String, Object> params)
        ...
        try {
            ...
            obj = businessDetailBo.countTask(dateStart, dateEnd);

        }
        catch (Throwable ex) {
            logger.warn("ReportSummaryDataService fail: {}", ex);
        }
